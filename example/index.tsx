...
const exampleSlides = [
    {
        type: 'simple',
        title: 'Слайдик',
        content: 'Простая слайдовая страничка много текста больше чем надо или меньше не знаю но почему-то раньше я не пробовал его особо менять почему неизвестно но нужно чтобы его было чуть больше чтобы проверить что происходит вообще здесь'
    },
    {
        type: 'simple',
